...
public class BuscarFreelancer implements ActionListener{
	...
	public void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BuscarFreelancer window = new BuscarFreelancer();
	...
	public void actionPerformed(ActionEvent e) {
		FiltrarFreelancer filtrar = new FiltrarFreelancer();
		filtrar.main();
	}
}
