...
public class CadastroFreelancer {
    ...
    Object [][] dados = {
        ...
        {"angular", "2 anos"},
        {"java web", "2 anos"},
        {"Lógica de programação", "10 anos"},
        {"Inglês monstrão", "10 anos"}
    };
	...
	private void initialize() {
		...
		panel = new JPanel();
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Adicionar Especialidade", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
